...
// main-v3 没有 i18n 体系，文案直接内联（main-v2 走 credits.paypal.* 词条）。
const MSG = {
      ...
      .then(() => {
        ...
        return window.paypal
          .Buttons({
            ...
            onError: () => {
              handlers.current.onError(MSG.incomplete)
            },
          })
          .render(containerRef.current)
      })
      .catch((err: unknown) => {
        setSdkError(err instanceof Error ? err.message : MSG.sdkFailed)
      })
