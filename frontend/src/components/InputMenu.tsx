...
const inputMenuItemClassName =
  'relative flex cursor-default select-none items-center gap-2.5 rounded-md px-2 py-1.5 text-[13px] text-foreground outline-hidden transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-accent data-[highlighted]:text-foreground'
    ...
    <DropdownMenuPrimitive.Sub>
      ...
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.SubContent
          sideOffset={sideOffset}
          className={inputMenuContentClassName}
        >
          {children}
        </DropdownMenuPrimitive.SubContent>
      </DropdownMenuPrimitive.Portal>
