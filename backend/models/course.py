...
class Course(Base):
    ...
    # The course pipeline this row belongs to. Video courses run the search +
    # organize + materialize machine; free courses are generated by ai.free_course
    # and carry structured learning objects. Lists/details MUST branch on it, or a
    # free course would open the video player (and vice versa).
...
class CourseChapter(Base):
    ...
    # Free-course map node: the lesson's learning objective (map node attribute).
    # Null for video chapters, which keep the video pipeline lifecycle.
    objective: Mapped[str | None] = mapped_column(Text, nullable=True)
    # Free-course: the generated LessonBlueprint for this lesson (objective /
    # prerequisites / sequence), kept for confirm/edit/regenerate and audit.
